...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/bermudadigitalstudio/Titan.git", .exact( "0.9.0-beta.2")),
        .package(url: "https://github.com/bermudadigitalstudio/TitanKituraAdapter.git", .exact( "0.9.0-beta.3")),
